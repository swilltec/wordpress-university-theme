  ...
  <header class="site-header">
    <div class="container">
      <h1 class="school-logo-text float-left">
        <a href="<?php echo site_url(); ?>"><strong>Swill</strong> University</a>
      </h1>
      ...
      <div class="site-header__menu group">
        ...
        ?> -->
            ...
            <li <?php if(get_post_type()) echo 'class="current-menu-item" '; ?>><a href="<?php echo get_post_type_archive_link('program')?>">Programs</a></li>
